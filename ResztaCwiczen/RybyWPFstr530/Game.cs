    ...
    class Game
    {
        ...
        public bool PlayOneRound(int selectedPlayerCard)
        {
            ...
            for (int i = 0; i < players.Count; i++)
            {
                ...
                if (stock.Count == 0)
                {
                    textBoxOnForm.Text ="Na kupce nie ma żadnych kart. Koniec Gry" + Environment.NewLine;
                    return true;
                }
            }
            return false;
        ...
        public string DescribeBooks()
        {
            ...
            foreach (Values value in books.Keys)
                whoHasWhichBooks += books[value].Name + " na grupę " + Card.Plural(value) + Environment.NewLine;
        ...
        public string DescribePlayerHands()
        {
            ...
            description += "Na kupce pozostało " + stock.Count + " kart";
            return description;
        }
    }
}
